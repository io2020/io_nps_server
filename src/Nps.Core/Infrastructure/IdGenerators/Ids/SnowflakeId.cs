...
namespace Nps.Core.Infrastructure.IdGenerators.Ids
{
    /// <summary>
    /// 雪花ID
    /// Twitter_Snowflake
    ...
    /// 并且效率较高，经测试，SnowFlake每秒能够产生出极限4,096,000个ID出
    /// </summary>
    public class SnowflakeId
    {
        ...
        public SnowflakeId(long dataCenterId, long workerId)
        {
            ...
            {
                throw new ArgumentException($"dataCenterId必须大于0，且不能大于{maxDatacenterId}");
            }
            if (workerId > maxWorkerId || workerId < 0)
            {
                throw new ArgumentException($"workerId必须大于0，且不能大于{maxWorkerId}");
            }
            WorkerId = workerId;
        ...
        public static string AnalyzeSnowflakeId(long Id)
        {
