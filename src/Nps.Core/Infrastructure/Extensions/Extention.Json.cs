...
namespace Nps.Core.Infrastructure.Extensions
{
    public static partial class Extention
    {
        ...
        {
            return jsonStr.IsNullOrWhiteSpace() ? default : JsonConvert.DeserializeObject<T>(jsonStr);
        }
        ...
        {
            return jsonStr.IsNullOrWhiteSpace() ? null : JsonConvert.DeserializeObject<List<T>>(jsonStr);
        }
        ...
        public static DataTable ToTable(this string jsonStr)
        {
            return jsonStr.IsNullOrWhiteSpace() ? null : JsonConvert.DeserializeObject<DataTable>(jsonStr);
        }
        ...
        {
            return jsonStr.IsNullOrWhiteSpace() ? JObject.Parse("{}") : JObject.Parse(jsonStr.Replace("&nbsp;", ""));
        }
    }
}