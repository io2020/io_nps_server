...
rem 数据库从库连接字符串
setx NPS_DB_SLAVECONNECTSTRING "Data Source=cpftu7fes6yg2ar7rn2j-rw4rm.rwlb.rds.aliyuncs.com;Port=3306;User ID=ionps;Password=ioNPS2020; Initial Catalog=ionps;Charset=utf8mb4; SslMode=none;Min pool size=1" /M
